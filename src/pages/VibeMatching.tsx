  ...
  return (
    <>
      ...
      <div className="w-full mx-auto relative px-4 sm:max-w-lg sm:px-4">
        <div className="mb-6">
          <label className="block text-sm font-medium mb-2 pt-4 md:pt-10">Your mood(s)</label>
          <div className="flex items-center gap-2 flex-wrap">
            <Input
              ...
              className="!h-8 !py-1 !px-2 text-xs md:!h-10 md:!py-2 md:!px-3 md:text-sm min-w-0 flex-1"
            />
            <Button
              variant="aura"
              onClick={handleFindMatches}
              className="!h-8 !px-2 !py-1 text-xs md:!h-10 md:!px-4 md:!py-2 md:text-sm whitespace-nowrap"
            >
              Search
            </Button>
            {userMoods.length > 0 && (
